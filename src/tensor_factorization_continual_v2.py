    ...
    def optimize(
        ...
        while True:
            ...
            def loss_fn():
                ...
                violation_term = (1 - self.constraint) * sign * reconstruction
                constraint_loss = constraint_lambda * torch.sum(violation_term) / n_c if n_c > 0 else 0
            ...
            if mse_loss < mse_tol:
                if self.verbose:
                    logging.info("Converged based on MSE tolerance.")
                break
